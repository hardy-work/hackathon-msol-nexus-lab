...
def main() -> int:
    previous = os.environ.get("KNOWLEDGE_BASE_EMBEDDING_BACKEND")
    os.environ["KNOWLEDGE_BASE_EMBEDDING_BACKEND"] = "hash"
    try:
        ...
        if previous is None:
            os.environ.pop("KNOWLEDGE_BASE_EMBEDDING_BACKEND", None)
        else:
            os.environ["KNOWLEDGE_BASE_EMBEDDING_BACKEND"] = previous
