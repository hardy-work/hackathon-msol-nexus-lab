...
# caller can still opt into Opus with ``KNOWLEDGE_BASE_WIKI_MODEL=opus`` (or
# the legacy heavy-model variable), while a long document defaults to Sonnet.
WIKI_MODEL = (os.getenv("KNOWLEDGE_BASE_WIKI_MODEL")
              or os.getenv("KNOWLEDGE_BASE_HEAVY_MODEL", "sonnet"))
...
# openclaw-skills/knowledge-base/`) thì đường dẫn tuyệt đối vượt 260 ký tự của Windows
