...
Gate 3b khởi chạy K phiên `claude -p --no-session-persistence` độc lập. Mặc định
chạy tối đa 3 phiên song song để giảm wall-clock time mà không giảm số phiếu;
đặt `KNOWLEDGE_BASE_REVIEW_WORKERS=1` trên host bị giới hạn concurrency. Bất kỳ
lượt timeout/lỗi nào cũng làm gate `KHÔNG CHẮC`, không được bỏ phiếu lỗi rồi PASS.
