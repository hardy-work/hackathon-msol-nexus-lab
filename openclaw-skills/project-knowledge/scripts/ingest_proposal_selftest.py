...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="pk-ingest-proposal-") as temp:
        ...
        old_state = os.environ.get("PROJECT_KNOWLEDGE_STATE_DIR")
        os.environ["PROJECT_KNOWLEDGE_STATE_DIR"] = str(state)
        try:
            try:
            ...
            if old_state is None:
                os.environ.pop("PROJECT_KNOWLEDGE_STATE_DIR", None)
            else:
                os.environ["PROJECT_KNOWLEDGE_STATE_DIR"] = old_state
