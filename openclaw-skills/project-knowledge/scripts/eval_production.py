...
def main() -> int:
    ...
    old_grants = os.environ.pop("PROJECT_KNOWLEDGE_COVERAGE_GRANTS", None)
    old_ids = os.environ.pop("PROJECT_KNOWLEDGE_APPROVAL_IDS", None)
    ...
    if old_grants is None:
        ...
        os.environ["PROJECT_KNOWLEDGE_COVERAGE_GRANTS"] = old_grants
    if old_ids is None:
        os.environ.pop("PROJECT_KNOWLEDGE_APPROVAL_IDS", None)
    else:
        os.environ["PROJECT_KNOWLEDGE_APPROVAL_IDS"] = old_ids
